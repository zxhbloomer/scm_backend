package com.xinyirun.scm.core.api.service.business.v1.out.v2;
 ...
 * @since 2021-11-12
 */
public interface ApiIOutV2Service extends ApiIBaseService<BOutPlanEntity> {
     ...
     * 中止出库计划
     */
    List<BOutPlanListVo> discontinue(ApiOutPlanDiscontinueVo vo);
