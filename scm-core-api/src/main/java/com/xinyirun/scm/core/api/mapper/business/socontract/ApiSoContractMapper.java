 ...
 */
@Repository
public interface ApiSoContractMapper extends BaseMapper<BSoContractEntity> {
     ...
     * @param soContractId
     */
    @Select("SELECT * FROM b_so_contract_detail WHERE so_contract_id = #{p1}")
    List<SoContractDetailVo> selectGoodsById(@Param("p1")Integer soContractId);
}
