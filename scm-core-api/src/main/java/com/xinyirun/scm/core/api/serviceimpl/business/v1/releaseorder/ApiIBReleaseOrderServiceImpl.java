...
import com.xinyirun.scm.core.api.mapper.business.releaseorder.ApiBReleaseOrderMapper;
import com.xinyirun.scm.core.api.service.business.v1.releaseorder.*;
 ...
 */
@Service
public class ApiIBReleaseOrderServiceImpl extends ServiceImpl<ApiBReleaseOrderMapper, BReleaseOrderEntity> implements ApiIBReleaseOrderService {

    @Autowired
    private ApiIBWkReleaseOrderService wkService;

    @Autowired
    private ApiIBWkReleaseOrderDetailService wkDetailService;

    @Autowired
    private ApiIBReleaseOrderDetailService detailService;

    @Autowired
    private ApiIBReleaseFilesService filesService;
    ...
    public void sync(List<ApiBReleaseOrderVo> list) {
        // 锁表
