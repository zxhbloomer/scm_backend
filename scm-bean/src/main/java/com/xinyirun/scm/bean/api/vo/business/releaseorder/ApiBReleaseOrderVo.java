...
@NoArgsConstructor
public class ApiBReleaseOrderVo implements Serializable {

    private static final long serialVersionUID = 6502214338618255777L;
     ...
     * 明细列表
     */
    List<ApiBReleaseOrderDetailVo> detailList;
}
