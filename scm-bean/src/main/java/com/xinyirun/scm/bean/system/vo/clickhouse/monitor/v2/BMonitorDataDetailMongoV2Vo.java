 ...
 */
@Data
public class BMonitorDataDetailMongoV2Vo implements Serializable {

    private static final long serialVersionUID = 4253762933664034005L;
     ...
     * 监管任务_出库对象
     */
    private BMonitorOutDeliveryDataMongoV2Vo monitorOutVo;
     ...
     * 监管任务_入库对象
     */
    private BMonitorInUnloadDataMongoV2Vo monitorInVo;
     ...
     * 图片详情
     */
    private List<BPreviewBackupDataV2Vo> previewFiles;
