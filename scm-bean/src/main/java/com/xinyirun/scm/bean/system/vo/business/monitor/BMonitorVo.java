...
@AllArgsConstructor
@Builder
public class BMonitorVo extends UploadFileResultAo implements Serializable {
     ...
     * 业务中台结算状态: 0未结算 1已结算
     */
    private String business_settlement_status;
    ...
    /**
     * 直销直采的审核时间 取值  （直销）出库审核时间 or （直采）入库审核时间
     */
    private LocalDateTime audit_time;


    /**
     * 直销直采的审核人 取值  （直销）出库人  or （直采）入库审核人
     */
     ...
     * 定位时间-新增/编辑车辆时候的定为时间
     */
    private LocalDateTime validate_gps_time;
     ...
     * 轨迹日志生成日期
     */
    private LocalDateTime track_c_time;

    /**
     * 入库单 生成方式
     */
    private String schedule_in_rule;
     ...
     * 物流 创建时间起止
     */
    private LocalDateTime b_schedule_time_start;
    private LocalDateTime b_schedule_time_end;

    /**
     * 物流状态
     */
    private String[] b_schedule_status;
     ...
     * 退货信息
     */
    private BReturnRelationVo returnRelationVo;
     ...
     */
    private String if_page_list;

    /**
     *  直销直采的审核人 取值  （直销）出库人  or （直采）入库审核审核时间（直采直销页面） 创建时间起止
     */
    private LocalDateTime audit_time_start;
    private LocalDateTime audit_time_end;
