...
public class BWoVo extends BaseVo implements Serializable {

    private static final long serialVersionUID = -2598952793928492674L;
     ...
     * 原材料 列表
     */
    private List<BWoMaterialVo> material_list;

    /**
     * 产成品, 副产品列表
     */
    private List<BWoProductVo> product_list;
    /**
     * 分页数据
     */
