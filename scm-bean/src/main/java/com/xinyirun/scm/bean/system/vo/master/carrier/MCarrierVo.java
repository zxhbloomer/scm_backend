...
@NoArgsConstructor
// @Schema( name = "承运商", description = "承运商")
public class MCarrierVo implements Serializable {

    private static final long serialVersionUID = -2630641021772191906L;
    /**
     * 主键id
     */
    private Integer id;
