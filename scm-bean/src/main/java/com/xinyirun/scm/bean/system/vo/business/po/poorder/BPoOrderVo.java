...
@NoArgsConstructor
public class BPoOrderVo extends BaseVo implements Serializable {
     ...
     * 商品信息
     */
    private List<BPoOrderDetailVo> detailListData;
...
//    private BigDecimal advance_pay_total;
     ...
     * 预付款可退金额
     */
    private BigDecimal advance_pay_refundable_price;
     ...
     * 是否预付款
     */
    private Boolean is_advance_pay; // 是否预付款
     ...
     * 采购合同信息
     */
    private BPoContractVo po_contract;
