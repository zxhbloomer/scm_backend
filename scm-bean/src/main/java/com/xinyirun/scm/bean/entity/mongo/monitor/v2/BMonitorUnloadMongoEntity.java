...
@Document("b_monitor_unload_v2")
public class BMonitorUnloadMongoEntity implements Serializable {

    private static final long serialVersionUID = -1196965841691420686L;
