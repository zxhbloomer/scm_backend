...
@NoArgsConstructor
public class BOutPlanVo implements Serializable {

    @Serial
    private static final long serialVersionUID = 7315520861753371431L;
     ...
     * 出库计划明细数据
     */
    private List<BOutPlanDetailVo> detailListData;
