package com.xinyirun.scm.bean.system.bo.inventory.commonlogic.in;
...
@Data
@Builder
public class StockInBo implements Serializable {

    @Serial
    private static final long serialVersionUID = 861344283747335588L;
...
//    @NotNull(message = "关联单据类型不能为空")
    private String serial_type = SerialType.BILL_BUSINESS_IN;
    // 关联单据id
