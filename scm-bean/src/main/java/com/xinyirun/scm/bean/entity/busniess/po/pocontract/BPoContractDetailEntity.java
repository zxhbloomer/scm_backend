package com.xinyirun.scm.bean.entity.busniess.po.pocontract;
...
@TableName("b_po_contract_detail")
@DataChangeEntityAnnotation(value="采购合同明细表-商品", type = "com.xinyirun.scm.core.system.serviceimpl.log.datachange.business.pocontract.DataChangeStrategyBPoContractDetailEntityServiceImpl")
public class BPoContractDetailEntity implements Serializable {
