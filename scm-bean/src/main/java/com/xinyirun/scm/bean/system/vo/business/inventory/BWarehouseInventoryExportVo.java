...
@NoArgsConstructor
public class BWarehouseInventoryExportVo implements Serializable {


    private static final long serialVersionUID = 1775896544352372433L;
    ...
    @ExcelProperty(value = "合计出库库存数量", index = 7)
    private BigDecimal out_qty;

    @ExcelProperty(value = "合计调整库存数量", index = 8)
    private BigDecimal qty_diff;

    @ExcelProperty(value = "存货合计", index = 9)
