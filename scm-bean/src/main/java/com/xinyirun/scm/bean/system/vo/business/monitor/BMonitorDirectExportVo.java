...
@NoArgsConstructor
public class BMonitorDirectExportVo implements Serializable {
    ...
    @ExcelProperty(value="物流订单号", index = 6)
    private String schedule_code;

    @ExcelProperty(value="采购/销售合同号", index = 7)
    private String contract_no;

    @ExcelProperty(value="物流合同号", index = 8)
    private String waybill_contract_no;

    @ExcelProperty(value="出库计划单号", index = 9)
    private String out_plan_code;

    @ExcelProperty(value="入库计划单号", index = 10)
    ...
    @ExcelProperty(value="司机", index = 25)
    private String driver_name;

    @ExcelProperty(value="车牌号", index = 26)
    private String vehicle_no;

    @ExcelProperty(value="验车状态", index = 27)
    private String validate_vehicle;

    @ExcelProperty(value="发货数量", index = 28)
    private BigDecimal out_qty;

    @ExcelProperty(value="发货单位", index = 29)
    private String unit_name1 = "吨";

    @ExcelProperty(value="收货数量", index = 30)
    private BigDecimal in_qty;

    @ExcelProperty(value="收货单位", index = 31)
    private String unit_name2 = "吨";

    @ExcelProperty(value="作废理由", index = 32)
    private String cancel_remark;

    @ExcelProperty(value="审核人", index = 33)
    private String audit_name;

    @ExcelProperty(value="审核时间", index = 34)
    @ColumnWidth(20)
    private String audit_time;

    @ExcelProperty(value="备份结果", index = 35)
    private String backup_flag;

    @ExcelProperty(value="备份状态", index = 36)
    ...
    @ExcelProperty(value="修改时间", index = 40)
    @ColumnWidth(20)
