...
@NoArgsConstructor
public class BDeliveryExportVo implements Serializable {
    ...
    @ExcelProperty(value="提货数量", index = 24)
    ...
    @ExcelProperty(value="金额", index = 27)
    private BigDecimal amount;

    @ExcelProperty(value="车牌号", index = 28)
    private String vehicle_no;

    @ExcelProperty(value="提货时间", index = 29)
    @ColumnWidth(20)
