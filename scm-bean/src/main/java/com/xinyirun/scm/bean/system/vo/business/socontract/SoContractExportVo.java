package com.xinyirun.scm.bean.system.vo.business.socontract;
...
@AllArgsConstructor
@NoArgsConstructor
public class SoContractExportVo implements Serializable {
    ...
    @ExcelProperty(value = "总采购数量", index = 18)
    ...
    @ExcelProperty(value = "预付款金额", index = 22)
    private BigDecimal advance_pay_price;

    @ExcelProperty(value = "累计实付", index = 23)
    private BigDecimal accumulated_act_price;

    @ExcelProperty(value = "未付", index = 24)
    private BigDecimal unpaid_amount;

    @ExcelProperty(value = "预付款可退金额", index = 25)
    ...
    @ExcelProperty(value = {"商品信息", "商品规格"}, index = 29)
    private String spec;
