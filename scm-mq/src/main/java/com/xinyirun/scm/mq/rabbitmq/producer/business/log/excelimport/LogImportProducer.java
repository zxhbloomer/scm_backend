package com.xinyirun.scm.mq.rabbitmq.producer.business.log.excelimport;
 ...
 */
@Component
public class LogImportProducer {

    @Autowired
    private ScmMqProducer mqProducer;

    public void mqSendMq(SLogImportMongoEntity data){
        MqSenderAo ao = MqSenderAoBuilder.buildMqSenderAo(data, MqSenderEnum.MQ_LOG_IMPORT_QUEUE);
        // 发送消息
        mqProducer.send(ao, MQEnum.MQ_LOG_IMPORT_QUEUE);
    }
}
