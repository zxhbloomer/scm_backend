package com.xinyirun.scm.mq.rabbitmq.producer.business.monitor.v2;
...
@Component
public class MonitorBackupV2Producer {

    @Autowired
    private ScmMqProducer mqProducer;

    public void mqSendMq(BBkMonitorLogDetailVo data){
        MqSenderAo ao = MqSenderAoBuilder.buildMqSenderAo(data, MqSenderEnum.MQ_MONITOR_BACKUP_QUEUE_V2);
        // 发送消息
        mqProducer.send(ao, MQEnum.MQ_MONITOR_BACKUP_QUEUE_V2);
    }
}
