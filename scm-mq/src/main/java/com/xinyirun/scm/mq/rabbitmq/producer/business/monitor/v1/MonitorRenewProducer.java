...
@Component
public class MonitorRenewProducer {

    @Autowired
    private ScmMqProducer mqProducer;

    public void mqSendMq(BBkMonitorLogDetailVo data){
        MqSenderAo ao = MqSenderAoBuilder.buildMqSenderAo(data, MqSenderEnum.MQ_MONITOR_RENEW_QUEUE);
        // 发送消息
        mqProducer.send(ao, MQEnum.MQ_MONITOR_RENEW_QUEUE);
    }
}
