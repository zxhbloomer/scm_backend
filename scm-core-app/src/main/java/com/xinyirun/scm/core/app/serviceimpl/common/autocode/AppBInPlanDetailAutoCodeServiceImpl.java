 ...
 * @Description: 自动生成编码：入库计划类
 * @Author: zxh
 * @date: 2019/12/13
 * @Version: 1.0
 */
@Component
public class AppBInPlanDetailAutoCodeServiceImpl implements AppIAutoCodeService {
    ...
    public SCodeEntity autoCode() {
        String type = DictConstant.DICT_SYS_CODE_TYPE_B_IN_PLAN_DETAIL;
