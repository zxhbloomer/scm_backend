package com.xinyirun.scm.core.app.config.mybatis.typehandlers;

import com.alibaba.fastjson2.JSON;
import com.alibaba.fastjson2.JSONWriter;
import com.xinyirun.scm.bean.app.vo.master.contact_list.AppMStaffPositionsVo;
 ...
 * @Version: 1.0
 */
@MappedTypes(value = {AppMStaffPositionsVo.class})
@MappedJdbcTypes(value = {JdbcType.VARCHAR}, includeNullJdbcType = true)
public class ContactListVoTypeHandler<T> extends BaseTypeHandler<T> {

    private Class<T> clazz;

    public ContactListVoTypeHandler(Class<T> clazz) {
        if (clazz == null) {
