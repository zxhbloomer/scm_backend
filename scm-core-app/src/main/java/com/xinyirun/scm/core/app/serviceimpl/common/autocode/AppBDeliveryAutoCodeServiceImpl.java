 ...
 * @Description: 自动生成编码：提货单类
 */
@Component
public class AppBDeliveryAutoCodeServiceImpl implements AppIAutoCodeService {
    ...
    public SCodeEntity autoCode() {
        String type = DictConstant.DICT_SYS_CODE_TYPE_B_DELIVERY;
