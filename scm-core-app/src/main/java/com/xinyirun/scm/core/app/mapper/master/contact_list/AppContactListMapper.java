package com.xinyirun.scm.core.app.mapper.master.contact_list;
...
import com.xinyirun.scm.core.app.config.mybatis.typehandlers.ContactListVoTypeHandler;
 ...
 */
@Repository
public interface AppContactListMapper extends BaseMapper<MStaffEntity> {
    ...
    List<AppContractListVo> list(@Param("p1") AppContractListVo searchCondition);
    ...
    AppContractListVo get(@Param("p1") AppContractListVo searchCondition);
}
