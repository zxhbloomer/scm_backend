...
import com.xinyirun.scm.clickhouse.service.quartz.SJobLogClickHouseService;
...
public class LogQuartzConsumer extends BaseMqConsumer {
    ...
    @Autowired
    private SJobLogClickHouseService sJobLogClickHouseService;
    ...
    public void onMessage(@Payload Message messageDataObject, @Headers Map<String, Object> headers, Channel channel) throws IOException {
        ...
        try {
            ...
            // 获取日志信息
            SJobLogClickHouseVo vo = (SJobLogClickHouseVo) messageContext;
            sJobLogClickHouseService.insert(vo);
            // 更新消费者状态
