...
import com.xinyirun.scm.bean.entity.business.rtwo.BRtWoRouterEntity;
 ...
 */
@Repository
public interface BRtWoRouterMapper extends BaseMapper<BRtWoRouterEntity> {
    ...
    BRtWoRouterVo getById(@Param("p1") Integer id);
    ...
    @Select(""
            ...
            + "   and EXISTS(                                                                                           "
            + "     select 1 from b_rt_wo_router_product sub2 left join m_goods_spec sub1 on sub2.sku_id = sub1.id         "
            + "     where true                                                                                          "
            ...
            + "   and EXISTS(                                                                                           "
            + "     select 1 from b_rt_wo_router_material sub2 left join m_goods_spec sub1 on sub2.sku_id = sub1.id         "
            + "     where true                                                                                          "
    ...
    IPage<BRtWoRouterVo> selectPageList(@Param("p1") BRtWoRouterVo param, Page<BRtWoRouterVo> pageCondition);
    ...
    BRtWoRouterVo selectById(Integer id);
}
