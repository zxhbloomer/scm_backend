package com.xinyirun.scm.core.system.mapper.master.inventory;
 ...
 */
@Repository
public interface MInventoryMapper extends BaseMapper<MInventoryEntity> {
    ...
    @Select("    "
            ...
            + "    order by lot asc                                                                        "
            + "      ")
    List<MInventoryEntity> select(@Param("p1") Integer bin_id,
    ...
    @Select("    "
            ...
            + "     for update                                                                                       "
            + "      ")
    List<MInventoryEntity> selectForUpdate(@Param("p1") Integer bin_id,
                                  @Param("p2") Integer owner_id,
                                  @Param("p3") String lot,
                                  @Param("p4") Integer sku_id
    );
    ...
    @Select("    "
            ...
            + "       where t1.id = #{p1}                                                                            "
            + "      ")
    MInventoryEntity getInventoryEntityById(@Param("p1") Integer id);
...
//            + "            sum(t.amount) amount,                                        "
    ...
    IPage<MMonitorInventoryVo> selectInventoryDiff(@Param("p1") MMonitorInventoryVo param, Page<MInventoryEntity> page);
