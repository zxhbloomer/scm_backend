package com.xinyirun.scm.core.system.mapper.sys.schedule.v4;
 ...
 * 关于库存日报表的mapper
 * 2024-4-3
 * http://yirunscm.com:8080/issue/WMS-948/
 *
 */
@Repository
public interface SBDailyInventoryBatchV4Mapper extends BaseMapper<BDailyInventoryEntity> {

    /**
     * 删除数据临时表
     */
    @Delete(
            "       delete from b_daily_inventory_batch_work_v3 ;                                               "
    )
     ...
     */
    @Delete(
            "       delete from b_daily_inventory_batch_temp_v3 ;                                               "
    )
     ...
     */
    @Delete(
            "       delete from b_daily_inventory_batch_final_temp_v3 ;                                "
    )
     ...
     */
    @Select(
        "       select 1 from b_daily_inventory_batch_temp_v3 for update nowait;                                               "
    )
     ...
     */
    @Select(
            "       select 1 from b_daily_inventory_batch_work_v3 for update nowait;                                               "
    )
     ...
     */
    @Select(
            "       select 1 from b_daily_inventory_batch_final_temp_v3 for update nowait;                                               "
    )
     ...
     */
    @Update({
            "         insert into b_daily_inventory_batch_work_v3                                                                "
            + "         (                                                                                                        "
            + "           dt,                                                                                                    "
            + "           type,                                                                                                  "
            + "           bill_type,                                                                                             "
            ...
            + "		WHERE                                                                                                        "
            + "			t1.STATUS = '1'                                                                                          "
            + "			AND t1.business_type = 'b_in'                                                                            "
            + "			                                                                                                         "
            + "			UNION ALL                                                                                                "
            + "			                                                                                                         "
            + "		SELECT                                                                                                       "
            + "			t1.cancel_time AS dt,                                                                                    "
            + "			'05' AS `type`,                                                                                          "
            + "			NULL AS bill_type,                                                                                       "
            + "			NULL AS plan_id,                                                                                         "
            + "			t1.owner_id,                                                                                             "
    ...
    @Update({""
            + "		insert into                                                                                          "
            + "			b_daily_inventory_batch_temp_v3 ( dt,                                                            "
            + "			owner_id,                                                                                        "
            + "			owner_code,                                                                                      "
            + "			sku_id,                                                                                          "
            + "			sku_code,                                                                                        "
            ...
            + "			qty_out,                                                                                         "
            + "			qty_adjust,                                                                                      "
            + "			qty_in_cancel_before ,                                                                           "
            + "			qty_in_cancel_after ,                                                                            "
            + "			qty_out_cancel_before ,                                                                          "
            + "			qty_out_cancel_after ,                                                                           "
            + "			unit_id,                                                                                         "
            + "			u_time )                                                                                         "
            + "		select                                                                                               "
            + "				ttt1.dt,                                                                                     "
            ...
            + "								- ttt1.qty_out                                                               "
            + "								+ ttt1.qty_adjust                                                            "
            + "								+ ttt1.qty_in_cancel_before                                                  "
            + "								- ttt1.qty_in_cancel_after                                                   "
            + "								- ttt1.qty_out_cancel_before                                                 "
            + "								+ ttt1.qty_out_cancel_after                                                  "
            + "				end as qty,                                                                                  "
            + "				ttt1.qty_in,                                                                                 "
            + "				ttt1.qty_out,                                                                                "
            + "				ttt1.qty_adjust,                                                                             "
            ...
            + "						 - tt1.qty_out                                                                       "
            + "						 + tt1.qty_adjust                                                                    "
            + "						 + tt1.qty_in_cancel_before                                                          "
            + "						 - tt1.qty_in_cancel_after                                                           "
            + "						 - tt1.qty_out_cancel_before                                                         "
            + "						 + tt1.qty_out_cancel_after as qty,                                                  "
            + "						tt1.qty_in,                                                                          "
            + "						tt1.qty_out,                                                                         "
            + "						tt1.qty_adjust,                                                                      "
            + "						tt1.unit_id,                                                                         "
            ...
            + "						sum(case when t1.`type` = '04' then t1.qty else 0 end) as qty_in_cancel_before,      "
            + "						sum(case when t1.`type` = '05' then t1.qty else 0 end) as qty_in_cancel_after,       "
            + "						sum(case when t1.`type` = '06' then t1.qty else 0 end) as qty_out_cancel_before,     "
            + "						sum(case when t1.`type` = '07' then t1.qty else 0 end) as qty_out_cancel_after,      "
            + "						unit_id as unit_id                                                                   "
            + "					from                                                                                     "
            + "						b_daily_inventory_batch_work_v3 t1                                                   "
            + "					group by                                                                                 "
     ...
     */
    @Update({ " "
            + "      insert into b_daily_inventory_batch_final_temp_v3 (                                                                   "
            + "      	dt,                                                                                                             "
            + "      	owner_id,                                                                                                       "
            + "      	owner_code,                                                                                                     "
            + "      	sku_id,                                                                                                         "
            ...
            + "			    sum(tab2.qty_in_cancel_before) qty_in_cancel_before ,                                                       "
            + "			    sum(tab2.qty_in_cancel_after) qty_in_cancel_after ,                                                         "
            + "			    sum(tab2.qty_out_cancel_before) qty_out_cancel_before ,                                                     "
            + "			    sum(tab2.qty_out_cancel_after) qty_out_cancel_after ,                                                       "
            + "             tab2.price ,                                                                                                "
            + "             tab2.amount ,                                                                                               "
            + "             tab2.unit_id ,                                                                                              "
            ...
            + "                           from s_calendar t1                                                                            "
            + "                          where t1.`date` between (select min(dt) from b_daily_inventory_batch_temp_v3) and now(3)       "
            + "                        ) sub1 ,                                                                                         "
            + "                        (                                                                                                "
            ...
            + "      					         count(1),                                                                              "
            + "      					         min(dt) min_dt                                                                         "
            + "      					    from b_daily_inventory_batch_temp_v3 t1                                                              "
            ...
            + "      ) tab1 left join b_daily_inventory_batch_temp_v3 tab2                                                                       "
    ...
    @Update({""
            + "	UPDATE b_daily_inventory_batch_final_temp_v3 tab1                                                                                            "
            + "	INNER JOIN (                                                                                                                                 "
            + "		SELECT                                                                                                                                   "
            + "			t1.dt,                                                                                                                               "
            + "		    sum( t1.qty_in                                                                                                                       "
            + "            - t1.qty_out + t1.qty_adjust                                                                                                      "
            + "            + qty_in_cancel_before                                                                                                            "
            + "            - qty_in_cancel_after                                                                                                             "
            + "            + qty_out_cancel_before                                                                                                           "
            + "            - qty_out_cancel_after ) over ( PARTITION BY t1.sku_id, t1.owner_id, t1.warehouse_id ORDER BY dt ) qty,                           "
            + "			t1.id                                                                                                                                "
            + "		FROM                                                                                                                                     "
            + "			b_daily_inventory_batch_final_temp_v3 t1                                                                                             "
    ...
    @Update({""
            + "		UPDATE                                                                                                                                                           "
            + "			b_daily_inventory_batch_final_temp_v3 tab0                                                                                                                   "
            + "			INNER JOIN (                                                                                                                                                 "
            + "			SELECT                                                                                                                                                       "
            + "				ttt0.id,                                                                                                                                                 "
            + "				ttt0.dt,                                                                                                                                                 "
            ...
            + "				ttt0.warehouse_id                                                                                                                                        "
            + "			FROM                                                                                                                                                         "
            + "				b_daily_inventory_batch_final_temp_v3 ttt0                                                                                                               "
            + "				INNER JOIN (                                                                                                                                             "
            + "				SELECT                                                                                                                                                   "
            + "					t1.CODE,                                                                                                                                             "
            + "					t2.target_sku_id,                                                                                                                                    "
     ...
     */
    @Update({""
            + "	UPDATE b_daily_inventory_batch_final_temp_v3 tab0                                                                                   "
            + "	INNER JOIN (                                                                                                                        "
            + "		SELECT                                                                                                                          "
            + "			ttt0.id,                                                                                                                    "
            + "			ttt0.dt,                                                                                                                    "
     ...
     */
    @Update({""
            + "		UPDATE b_daily_inventory_batch_final_temp_v3 ttt0                                                   "
    ...
    @Update({""
            ...
            + "   	t1.bin_id,                                                                                                                "
            + "   	t1.qty,                                                                                                                   "
            + "   	ifnull(t1.qty_in,0) + ifnull(t1.qty_in_cancel_before,0) - ifnull(t1.qty_in_cancel_after,0) qty_in,                        "
            + "   	ifnull(t1.qty_out,0) + ifnull(t1.qty_out_cancel_before,0) - ifnull(t1.qty_out_cancel_after,0) qty_out,                    "
