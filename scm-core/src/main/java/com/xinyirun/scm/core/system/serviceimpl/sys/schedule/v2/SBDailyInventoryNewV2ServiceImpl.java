...
@Service
@Slf4j
public class  SBDailyInventoryNewV2ServiceImpl extends BaseServiceImpl<SBDailyInventoryV2Mappper, BDailyInventoryEntity> implements ISBDailyInventoryNewV2Service {

    @Autowired
    SBDailyInventoryV2Mappper mapper;
...
//            mapper.lockAllTable14();
        ...
        mapper.createTemoraryWorkData20(condition);
