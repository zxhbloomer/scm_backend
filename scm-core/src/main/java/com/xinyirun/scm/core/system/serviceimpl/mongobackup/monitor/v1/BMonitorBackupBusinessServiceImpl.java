...
import com.xinyirun.scm.core.system.mapper.mongobackup.monitor.v1.BMonitorBackupMapper;
...
@Service
@Slf4j
public class BMonitorBackupBusinessServiceImpl extends ServiceImpl<BMonitorMapper, BMonitorEntity> implements IBMonitorBackupBusinessService {

    @Autowired
    private BMonitorBackupMapper mapper;

    @Autowired
    private IBMonitorInBackupService monitorInService;

    @Autowired
    private IBMonitorOutBackupService monitorOutService;
...
//    }
     ...
     */
    public BMonitorDataDetailMongoVo getDetail(Integer id) {
        // 获取监管任务详情
        BMonitorDataDetailMongoVo monitorVo = mapper.selectId(id);
//        StopWatchUtil.stopAndStartNew("查询详情", "111", "111");
        // 获取监管入库详情
        BMonitorInUnloadDataMongoVo monitorInVo = monitorInService.selectMonitorInUnloadByMonitorId(id);
...
//            monitorInVo.setContainerInfos(ibContainerInfoService.selectContainerInfos(monitorInVo.getId(), monitorInVo.getType()));
        ...
        // 获取监管出库详情
        BMonitorOutDeliveryDataMongoVo monitorOutVo = monitorOutService.selectOutDeliveryByMonitorId(id);
...
//            monitorOutVo.setContainerInfos(ibContainerInfoService.selectContainerInfos(monitorOutVo.getId(), monitorOutVo.getType()));
        ...
        // 获取图片地址
        List<BPreviewBackupDataVo> previewFiles = getPreviewFiles(id);
    ...
    public void getMonitorFiles(Integer monitorId) {
        BMonitorFilePreviewBackupDataVo monitorFile = mapper.getMonitorFile(monitorId);
     ...
     * 查询所有的 文件ID
         * @param vo
     */
    private List<Integer> getAllFileId(BMonitorFilePreviewBackupDataVo vo) {
     ...
     */
    private BMonitorTrackMongoDataVo getTrack(BMonitorDataDetailMongoVo detailMongoVo) {
...
//    }
     ...
     * 设置返回页面入库监管附件对象
     */
    public void setFile(BMonitorInUnloadDataMongoVo vo) {
     ...
     * 设置返回页面出库监管附件对象
     */
    public void setFile(BMonitorOutDeliveryDataMongoVo vo) {
        SFileMonitorInfoMongoVo emptyVo = new SFileMonitorInfoMongoVo();
        SFileMonitorInfoMongoVo fileInfoVo;
        // 空车过磅附件
        if (vo.getOne_file() != null) {
    ...
    private List<BPreviewBackupDataVo> getPreviewFiles(Integer id) {
        BMonitorFilePreviewBackupDataVo result = mapper.getMonitorFile(id);
        setPreviewMonitorFileTitle(result);
        int i = 0;
        List<BPreviewBackupDataVo> bPreviewDataVoList = new ArrayList<>();
        if (result.getFile_1() != null && StringUtils.isNotEmpty(result.getFile_1().getUrl())) {
            BPreviewBackupDataVo bPreviewDataVo = getBPreviewData(result.getFile_1(), i, 1);
            i++;
            bPreviewDataVoList.add(bPreviewDataVo);
        }
        if (result.getFile_2() != null && StringUtils.isNotEmpty(result.getFile_2().getUrl())) {
            BPreviewBackupDataVo bPreviewDataVo = getBPreviewData(result.getFile_2(), i, 2);
            i++;
            bPreviewDataVoList.add(bPreviewDataVo);
        }
        if (result.getFile_3() != null && StringUtils.isNotEmpty(result.getFile_3().getUrl())) {
            BPreviewBackupDataVo bPreviewDataVo = getBPreviewData(result.getFile_3(), i, 3);
            i++;
            bPreviewDataVoList.add(bPreviewDataVo);
        }
        if (result.getFile_4() != null && StringUtils.isNotEmpty(result.getFile_4().getUrl())) {
            BPreviewBackupDataVo bPreviewDataVo = getBPreviewData(result.getFile_4(), i, 4);
            i++;
            bPreviewDataVoList.add(bPreviewDataVo);
        }
        if (result.getFile_5() != null && StringUtils.isNotEmpty(result.getFile_5().getUrl())) {
            BPreviewBackupDataVo bPreviewDataVo = getBPreviewData(result.getFile_5(), i, 5);
            i++;
            bPreviewDataVoList.add(bPreviewDataVo);
        }
        if (result.getFile_6() != null && StringUtils.isNotEmpty(result.getFile_6().getUrl())) {
            BPreviewBackupDataVo bPreviewDataVo = getBPreviewData(result.getFile_6(), i, 6);
            i++;
            bPreviewDataVoList.add(bPreviewDataVo);
        }
        if (result.getFile_7() != null && StringUtils.isNotEmpty(result.getFile_7().getUrl())) {
            BPreviewBackupDataVo bPreviewDataVo = getBPreviewData(result.getFile_7(), i, 7);
            i++;
            bPreviewDataVoList.add(bPreviewDataVo);
        }
        if (result.getFile_8() != null && StringUtils.isNotEmpty(result.getFile_8().getUrl())) {
            BPreviewBackupDataVo bPreviewDataVo = getBPreviewData(result.getFile_8(), i, 8);
            i++;
            bPreviewDataVoList.add(bPreviewDataVo);
        }
        if (result.getFile_9() != null && StringUtils.isNotEmpty(result.getFile_9().getUrl())) {
            BPreviewBackupDataVo bPreviewDataVo = getBPreviewData(result.getFile_9(), i, 9);
            i++;
            bPreviewDataVoList.add(bPreviewDataVo);
        }
        if (result.getFile_10() != null && StringUtils.isNotEmpty(result.getFile_10().getUrl())) {
            BPreviewBackupDataVo bPreviewDataVo = getBPreviewData(result.getFile_10(), i, 10);
            i++;
            bPreviewDataVoList.add(bPreviewDataVo);
        }
        if (result.getFile_11() != null && StringUtils.isNotEmpty(result.getFile_11().getUrl())) {
            BPreviewBackupDataVo bPreviewDataVo = getBPreviewData(result.getFile_11(), i, 11);
            i++;
            bPreviewDataVoList.add(bPreviewDataVo);
        }
        if (result.getFile_12() != null && StringUtils.isNotEmpty(result.getFile_12().getUrl())) {
            BPreviewBackupDataVo bPreviewDataVo = getBPreviewData(result.getFile_12(), i, 12);
            i++;
            bPreviewDataVoList.add(bPreviewDataVo);
        }
        if (result.getFile_13() != null && StringUtils.isNotEmpty(result.getFile_13().getUrl())) {
            BPreviewBackupDataVo bPreviewDataVo = getBPreviewData(result.getFile_13(), i, 13);
            i++;
            bPreviewDataVoList.add(bPreviewDataVo);
        }
        if (result.getFile_14() != null && StringUtils.isNotEmpty(result.getFile_14().getUrl())) {
            BPreviewBackupDataVo bPreviewDataVo = getBPreviewData(result.getFile_14(), i, 14);
            i++;
            bPreviewDataVoList.add(bPreviewDataVo);
        }
        if (result.getFile_15() != null && StringUtils.isNotEmpty(result.getFile_15().getUrl())) {
            BPreviewBackupDataVo bPreviewDataVo = getBPreviewData(result.getFile_15(), i, 15);
            i++;
            bPreviewDataVoList.add(bPreviewDataVo);
        }
        if (result.getFile_16() != null && StringUtils.isNotEmpty(result.getFile_16().getUrl())) {
            BPreviewBackupDataVo bPreviewDataVo = getBPreviewData(result.getFile_16(), i, 16);
            i++;
            bPreviewDataVoList.add(bPreviewDataVo);
        }
        if (result.getFile_17() != null && StringUtils.isNotEmpty(result.getFile_17().getUrl())) {
            BPreviewBackupDataVo bPreviewDataVo = getBPreviewData(result.getFile_17(), i, 17);
            i++;
            bPreviewDataVoList.add(bPreviewDataVo);
        }
        if (result.getFile_18() != null && StringUtils.isNotEmpty(result.getFile_18().getUrl())) {
            BPreviewBackupDataVo bPreviewDataVo = getBPreviewData(result.getFile_18(), i, 18);
            i++;
            bPreviewDataVoList.add(bPreviewDataVo);
        }
        if (result.getFile_19() != null && StringUtils.isNotEmpty(result.getFile_19().getUrl())) {
            BPreviewBackupDataVo bPreviewDataVo = getBPreviewData(result.getFile_19(), i, 19);
            i++;
            bPreviewDataVoList.add(bPreviewDataVo);
        }
        if (result.getFile_20() != null && StringUtils.isNotEmpty(result.getFile_20().getUrl())) {
            BPreviewBackupDataVo bPreviewDataVo = getBPreviewData(result.getFile_20(), i, 20);
            i++;
            bPreviewDataVoList.add(bPreviewDataVo);
        }
        if (result.getFile_21() != null && StringUtils.isNotEmpty(result.getFile_21().getUrl())) {
            BPreviewBackupDataVo bPreviewDataVo = getBPreviewData(result.getFile_21(), i, 21);
            i++;
            bPreviewDataVoList.add(bPreviewDataVo);
        }
        if (result.getFile_22() != null && StringUtils.isNotEmpty(result.getFile_22().getUrl())) {
            BPreviewBackupDataVo bPreviewDataVo = getBPreviewData(result.getFile_22(), i, 22);
            i++;
            bPreviewDataVoList.add(bPreviewDataVo);
        }
        if (result.getFile_23() != null && StringUtils.isNotEmpty(result.getFile_23().getUrl())) {
            BPreviewBackupDataVo bPreviewDataVo = getBPreviewData(result.getFile_23(), i, 23);
            i++;
            bPreviewDataVoList.add(bPreviewDataVo);
        }
        if (result.getFile_24() != null && StringUtils.isNotEmpty(result.getFile_24().getUrl())) {
            BPreviewBackupDataVo bPreviewDataVo = getBPreviewData(result.getFile_24(), i, 24);
            i++;
            bPreviewDataVoList.add(bPreviewDataVo);
        }
        if (result.getFile_25() != null && StringUtils.isNotEmpty(result.getFile_25().getUrl())) {
            BPreviewBackupDataVo bPreviewDataVo = getBPreviewData(result.getFile_25(), i, 25);
            i++;
            bPreviewDataVoList.add(bPreviewDataVo);
        }
        if (result.getFile_26() != null && StringUtils.isNotEmpty(result.getFile_26().getUrl())) {
            BPreviewBackupDataVo bPreviewDataVo = getBPreviewData(result.getFile_26(), i, 26);
            i++;
            bPreviewDataVoList.add(bPreviewDataVo);
        }
        if (result.getFile_27() != null && StringUtils.isNotEmpty(result.getFile_27().getUrl())) {
            BPreviewBackupDataVo bPreviewDataVo = getBPreviewData(result.getFile_27(), i, 27);
            i++;
            bPreviewDataVoList.add(bPreviewDataVo);
        }
        if (result.getFile_28() != null && StringUtils.isNotEmpty(result.getFile_28().getUrl())) {
            BPreviewBackupDataVo bPreviewDataVo = getBPreviewData(result.getFile_28(), i, 28);
            i++;
            bPreviewDataVoList.add(bPreviewDataVo);
        }
        if (result.getFile_29() != null && StringUtils.isNotEmpty(result.getFile_29().getUrl())) {
            BPreviewBackupDataVo bPreviewDataVo = getBPreviewData(result.getFile_29(), i, 29);
            i++;
            bPreviewDataVoList.add(bPreviewDataVo);
        }
        if (result.getFile_30() != null && StringUtils.isNotEmpty(result.getFile_30().getUrl())) {
            BPreviewBackupDataVo bPreviewDataVo = getBPreviewData(result.getFile_30(), i, 30);
            i++;
            bPreviewDataVoList.add(bPreviewDataVo);
        }
        if (result.getFile_31() != null && StringUtils.isNotEmpty(result.getFile_31().getUrl())) {
            BPreviewBackupDataVo bPreviewDataVo = getBPreviewData(result.getFile_31(), i, 31);
            i++;
            bPreviewDataVoList.add(bPreviewDataVo);
        }
        if (result.getFile_32() != null && StringUtils.isNotEmpty(result.getFile_32().getUrl())) {
            BPreviewBackupDataVo bPreviewDataVo = getBPreviewData(result.getFile_32(), i, 32);
            i++;
            bPreviewDataVoList.add(bPreviewDataVo);
        }
        if (result.getFile_33() != null && StringUtils.isNotEmpty(result.getFile_33().getUrl())) {
            BPreviewBackupDataVo bPreviewDataVo = getBPreviewData(result.getFile_33(), i, 33);
            i++;
            bPreviewDataVoList.add(bPreviewDataVo);
        }
        if (result.getFile_34() != null && StringUtils.isNotEmpty(result.getFile_34().getUrl())) {
            BPreviewBackupDataVo bPreviewDataVo = getBPreviewData(result.getFile_34(), i, 34);
            i++;
            bPreviewDataVoList.add(bPreviewDataVo);
        }
        if (result.getFile_35() != null && StringUtils.isNotEmpty(result.getFile_35().getUrl())) {
            BPreviewBackupDataVo bPreviewDataVo = getBPreviewData(result.getFile_35(), i, 35);
            i++;
            bPreviewDataVoList.add(bPreviewDataVo);
        }
        if (result.getFile_36() != null && StringUtils.isNotEmpty(result.getFile_36().getUrl())) {
            BPreviewBackupDataVo bPreviewDataVo = getBPreviewData(result.getFile_36(), i, 36);
            i++;
            bPreviewDataVoList.add(bPreviewDataVo);
        }
        if (result.getFile_37() != null && StringUtils.isNotEmpty(result.getFile_37().getUrl())) {
            BPreviewBackupDataVo bPreviewDataVo = getBPreviewData(result.getFile_37(), i, 37);
            bPreviewDataVoList.add(bPreviewDataVo);
        }
        if (result.getFile_38() != null && StringUtils.isNotEmpty(result.getFile_38().getUrl())) {
            BPreviewBackupDataVo bPreviewDataVo = getBPreviewData(result.getFile_38(), i, 38);
            bPreviewDataVoList.add(bPreviewDataVo);
        }
        if (result.getFile_39() != null && StringUtils.isNotEmpty(result.getFile_39().getUrl())) {
            BPreviewBackupDataVo bPreviewDataVo = getBPreviewData(result.getFile_39(), i, 39);
            bPreviewDataVoList.add(bPreviewDataVo);
        }
    ...
    private void setPreviewMonitorFileTitle(BMonitorFilePreviewBackupDataVo vo) {
    ...
    private BPreviewBackupDataVo getBPreviewData(BMonitorPreviewFileVo vo, int i, int file_num) {
        BPreviewBackupDataVo bPreviewDataVo = new BPreviewBackupDataVo();
