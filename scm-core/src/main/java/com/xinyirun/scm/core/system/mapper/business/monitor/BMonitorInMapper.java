 ...
 */
@Repository
public interface BMonitorInMapper extends BaseMapper<BMonitorInEntity> {
    ...
    @Select("    "
            ...
            + "      ")
    IPage<BMonitorInUnloadVo> selectPage(Page page, @Param("p1") BMonitorInUnloadVo searchCondition);
    ...
    @Select("    "
            ...
            + "      ")
    BMonitorInUnloadVo selectId(@Param("p1") Integer id);
    ...
    @Select("    "
            ...
            + "      ")
    BMonitorInUnloadVo selectMonitorInUnloadByMonitorId(@Param("p1") Integer id);
