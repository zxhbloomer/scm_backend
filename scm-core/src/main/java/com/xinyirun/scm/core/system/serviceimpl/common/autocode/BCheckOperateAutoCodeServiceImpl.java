 ...
 * @Description: 自动生成编码：盘点操作
 */
@Component
public class BCheckOperateAutoCodeServiceImpl implements IAutoCodeService {
    ...
    public SCodeEntity autoCode() {
        String type = DictConstant.DICT_SYS_CODE_TYPE_B_CHECK_OPERATE;
