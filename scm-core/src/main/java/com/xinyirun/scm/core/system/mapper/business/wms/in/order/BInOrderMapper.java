...
import com.xinyirun.scm.bean.system.vo.business.wms.inventory.BBuyContractReportExportVo;
...
public interface BInOrderMapper extends BaseMapper<BInOrderEntity> {
    ...
    String common_select = "  "
            ...
            +  "    WHERE t1.status = '" + DictConstant.DICT_B_IN_STATUS_TWO + "'                                                                        "
...
//            + "      left join m_goods_spec t8 on t8.id = t7.sku_id                                                                                         "
    ...
    String common_selectReport =  ""
            ...
            +   "                 and t8.status = '" +  DictConstant.DICT_B_IN_STATUS_TWO + "'              "
