 ...
 * @Description: 自动生成编码：应付退账款明细表
 */
@Component
public class BApReFundDetailAutoCodeServiceImpl implements IAutoCodeService {
    ...
    public SCodeEntity autoCode() {
        String type = DictConstant.DICT_SYS_CODE_TYPE_B_AP_REFUND_DETAIL;
