...
/**
 * @ClassName: BArDetailAutoCodeServiceImpl
 * @Description: 自动生成编码：应收账款明细表
 */
@Component
public class BArDetailAutoCodeServiceImpl implements IAutoCodeService {
    ...
    public SCodeEntity autoCode() {
        String type = DictConstant.DICT_SYS_CODE_TYPE_B_AR_DETAIL;
