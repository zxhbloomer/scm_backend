...
public interface BApRefundPayMapper extends BaseMapper<BApReFundPayEntity> {
    ...
    @Select( "SELECT                                                                                                            "
            ...
            +"	LEFT JOIN s_dict_data tab4 ON tab4.CODE = '"+ DictConstant.DICT_B_AP_REFUND_PAY_ONE_STATUS +"'                  "
            +"	AND tab4.dict_value = tab1.status                                                                               "
            +"	LEFT JOIN s_dict_data tab5 ON tab5.CODE = '"+ DictConstant.DICT_B_AP_REFUND_TYPE +"'                            "
    ...
    @Select( "SELECT                                                                                                            "
            ...
            +"	LEFT JOIN s_dict_data tab10 ON tab10.CODE = '"+ DictConstant.DICT_B_PO_ORDER_PAYMENT_TYPE +"'                   "
