...
/**
 * @ClassName: BFundUsageAutoCodeServiceImpl
 * @Description: 自动生成编码：资金使用情况
 */
@Component
public class BFundUsageAutoCodeServiceImpl implements IAutoCodeService {
    ...
    public SCodeEntity autoCode() {
        String type = DictConstant.DICT_SYS_CODE_TYPE_B_FUND_USAGE;
