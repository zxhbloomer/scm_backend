...
/**
 * @ClassName: BFundMonitorAutoCodeServiceImpl
 * @Description: 自动生成编码：资金监控
 */
@Component
public class BFundMonitorAutoCodeServiceImpl implements IAutoCodeService {
    ...
    public SCodeEntity autoCode() {
        String type = DictConstant.DICT_SYS_CODE_TYPE_B_FUND_MONITOR;
