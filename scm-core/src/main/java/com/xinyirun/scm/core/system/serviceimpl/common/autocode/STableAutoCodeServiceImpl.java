...
/**
 * @ClassName: STableAutoCodeServiceImpl
 * @Description: 自动生成编码：前端页面-列位置顺序设置
 */
@Component
public class STableAutoCodeServiceImpl implements IAutoCodeService {
    ...
    public SCodeEntity autoCode() {
        String type = DictConstant.DICT_SYS_CODE_TYPE_S_TABLE_CONFIG;
