 ...
 * @Description: 自动生成编码：vue 页面配置类
 * @Author: zxh
 * @date: 2019/12/13
 * @Version: 1.0
 */
@Component
public class MVuePageSettingAutoCodeServiceImpl implements IAutoCodeService {
    ...
    public SCodeEntity autoCode() {
        String type = DictConstant.DICT_SYS_CODE_TYPE_S_VUE_PAGE_SETTING;
