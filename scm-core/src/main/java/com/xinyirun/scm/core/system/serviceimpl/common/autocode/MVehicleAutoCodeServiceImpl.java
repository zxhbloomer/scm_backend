...
/**
 * @ClassName: MVehicleAutoCodeServiceImpl
 * @Description: 自动生成编码：车辆
 */
@Component
public class MVehicleAutoCodeServiceImpl implements IAutoCodeService {
    ...
    public SCodeEntity autoCode() {
        String type = DictConstant.DICT_SYS_CODE_TYPE_M_VEHICLE;
