...
public interface BPoCargoRightTransferTotalMapper extends BaseMapper<BPoCargoRightTransferTotalEntity> {
    ...
    @Select("""
        ...
        """)
    BPoCargoRightTransferTotalVo selectByCargoRightTransferId(@Param("cargoRightTransferId") Integer cargoRightTransferId);
     ...
     */
    @Select("""
        INSERT INTO b_po_cargo_right_transfer_total (
     ...
     */
    @Select("""
        DELETE FROM b_po_cargo_right_transfer_total 
        WHERE cargo_right_transfer_id = #{cargoRightTransferId}
        """)
