 ...
 */
@Repository
public interface BMonitorBackupMapper extends BaseMapper<BMonitorEntity> {
...
//            + "    and (t1.flag != 'ING' OR t1.flag is null)                                                            "
    ...
    @Select(" <script>   "
            ...
            + " </script>     ")
    BMonitorDataDetailMongoVo selectId(@Param("p1") Integer id);
    ...
    BMonitorFilePreviewBackupDataVo getMonitorFile(@Param("p1") Integer id);
