...
import com.xinyirun.scm.bean.entity.business.po.appay.*;
...
import com.xinyirun.scm.core.system.mapper.business.po.ap.BApSourceMapper;
import com.xinyirun.scm.core.system.mapper.business.po.ap.BApTotalMapper;
import com.xinyirun.scm.core.system.mapper.business.po.appay.*;
    ...
    private void savePaySourceAdvance(BApPayVo searchCondition, BApPayEntity bApPayEntity) {
        ...
        if (CollectionUtil.isNotEmpty(apSourceAdvanceList)) {
            for (BApSourceAdvanceVo apSourceAdvanceVo : apSourceAdvanceList) {
                ...
                paySourceAdvanceEntity.setPo_qty(apSourceAdvanceVo.getPo_qty());
                paySourceAdvanceEntity.setPo_amount(apSourceAdvanceVo.getPo_amount());
