 ...
 */
@Repository
public interface RProductDailyDMapper extends BaseMapper<RProductDailyDEntity> {
...
//            + " AND (date_format(date, '%Y-%m-%d') <= #{p1.end_time} or #{p1.end_time} is null)                         "
    ...
    void deleteR_product_daily_d_51(@Param("p1") BProductDailyVo vo);

    @Insert("<script>"
            +  "  INSERT INTO r_product_daily_d ( date, warehouse_id, in_qty, out_qty, loss_qty, residue_qty, c_time ) SELECT"
            +  "  tab1.date,                                                                                            "
            +  "  tab1.warehouse_id,                                                                                    "
            +  "  tab2.in_qty,                                                                                          "
            +  "  tab3.out_qty,                                                                                         "
...
//            +  "  		AND (date_format(date, '%Y-%m-%d') &lt;= #{p1.end_time} or #{p1.end_time} is null)              "
            ...
            +  "  	LEFT JOIN (                                                                                         "
            +  "  	SELECT                                                                                              "
            +  "  		SUM( t.actual_weight ) - sum(IFNULL(t.return_qty,0)) out_qty,                                   "
            +  "  		DATE_FORMAT( t.e_dt, '%Y-%m-%d' ) date,                                                         "
            +  "  		t.warehouse_id                                                                                  "
            +  "  	FROM                                                                                                "
            +  "  		b_out t                                                                                         "
            ...
            +  "  WHERE                                                                                                 "
//            +  "   (tab2.in_qty is not null or tab3.out_qty is not null or tab4.loss_qty is not null or tab5.residue_qty is not null)"
            +  "   (ifnull(tab2.in_qty, 0) != 0 or ifnull(tab3.out_qty, 0) != 0 or ifnull(tab4.loss_qty, 0) != 0 or ifnull(tab5.residue_qty, 0) != 0)"
            +  "</script>"
    )
    void insertR_product_daily_d_52(@Param("p1") BProductDailyVo vo);
    ...
    void deleteR_product_daily_d_501(@Param("p1") BProductDailyVo vo);
...
//            +  "   (tab2.in_qty is not null or tab3.out_qty is not null or tab4.loss_qty is not null or tab5.residue_qty is not null)"
    ...
    void insertR_product_daily_d_502(@Param("p1") BProductDailyVo vo);
}
