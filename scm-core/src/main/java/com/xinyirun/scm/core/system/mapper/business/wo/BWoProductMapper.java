 ...
 */
@Repository
public interface BWoProductMapper extends BaseMapper<BWoProductEntity> {
    ...
    List<BWoRouterProductVo> selectList(@Param("p1") BWoRouterProductVo param);
    ...
    List<BWoProductVo> selectByWoId(@Param("p1") Integer wo_id);
