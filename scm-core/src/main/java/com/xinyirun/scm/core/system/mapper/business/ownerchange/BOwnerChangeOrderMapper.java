 ...
 */
@Repository
public interface BOwnerChangeOrderMapper extends BaseMapper<BOwnerChangeOrderEntity> {
     ...
     */
    @Select("    "
            + "  select t.* from b_owner_change_order t where true                                                                                    "
            ...
            + "      ")
    List<BOwnerChangeOrderEntity> selectOrderByContract(@Param("p1") BOwnerChangeOrderVo vo);
    ...
    String common_select = "  "
            ...
            + "              where tab2.code = '" + DictConstant.DICT_B_OWNER_CHANGE_ORDER_BUSINESS_TYPE + "')t5 on t5.dict_value = t.bill_type             "
            + "                                                                        "
            ;
    ...
    @Select("    "
            ...
            + "      ")
    IPage<BOwnerChangeOrderVo> selectPage(Page page, @Param("p1") BOwnerChangeOrderVo searchCondition);
    ...
    @Select("    "
            ...
            + "      ")
    BOwnerChangeOrderVo selectId(@Param("p1") int id);
    ...
    @Select("    "
            ...
            + "      ")
    BOwnerChangeOrderEntity selectByOrderNo(@Param("p1") String orderNo);
}
