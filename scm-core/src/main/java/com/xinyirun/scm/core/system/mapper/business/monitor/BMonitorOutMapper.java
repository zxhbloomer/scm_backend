 ...
 */
@Repository
public interface BMonitorOutMapper extends BaseMapper<BMonitorOutEntity> {
    ...
    @Select("                                                                                                       "
            ...
            + "     ")
    BMonitorOutEntity selectByMonitorOut(@Param("p1") Integer id);
    ...
    String common_select = "  "
            ...
            + "            t1.name as c_name,                                                                           "
            + "            t2.name as u_name,                                                                           "
            + "            t12.extra_code out_extra_code,                                                               "
            + "            t13.code out_code,                                                                           "
            + "            t13.is_settled is_settled,                                                                   "
            + "            t14.owner_id owner_id,                                                                       "
            + "            t14.owner_code owner_code,                                                                   "
            + "            t14.consignor_id consignor_id,                                                               "
            + "            t14.consignor_code consignor_code                                                           "
            + "       FROM                                                                                              "
            ...
            + "  LEFT JOIN b_out_plan_detail t12 ON t4.out_plan_detail_id = t12.id                                      "
            + "  LEFT JOIN b_out t13 ON t13.id = t.out_id                                                               "
            + "  LEFT JOIN b_out_plan t14 ON t14.id = t13.plan_id                                                               "
...
//            + "      ")
//    IPage<AppBMonitorOutVo> selectPage(Page page, @Param("p1") AppBMonitorOutVo searchCondition);
...
//            + "    and (t.id =  #{p1,jdbcType=INTEGER} or #{p1,jdbcType=INTEGER} is null)                "
//            + "      ")
//    AppBMonitorOutVo selectId(@Param("p1") Integer id);
    ...
    @Select("    "
            ...
            + "     ")
    BMonitorOutEntity selectByScheduleId(@Param("p1") Integer id);
    ...
    @Select("    "
            ...
            + "      ")
    BMonitorOutDeliveryVo selectOutDeliveryByMonitorId(@Param("p1") Integer id);
    ...
    @Select("    "
            ...
            + "  where true                                                                                             "
            + "    and (t.id =  #{p1,jdbcType=INTEGER} or #{p1,jdbcType=INTEGER} is null)                               "
            + "    and (t.type =  #{p2,jdbcType=VARCHAR} or #{p2,jdbcType=VARCHAR} is null)                             "
            + "      ")
    BMonitorOutDeliveryVo selectOutDeliveryById(@Param("p1") Integer id, @Param("p2") String type);
