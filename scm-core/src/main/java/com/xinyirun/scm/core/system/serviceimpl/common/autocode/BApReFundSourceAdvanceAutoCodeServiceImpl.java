 ...
 * @Description: 自动生成编码：应付退账款关联单据表-源单-预收款
 */
@Component
public class BApReFundSourceAdvanceAutoCodeServiceImpl implements IAutoCodeService {
    ...
    public SCodeEntity autoCode() {
        String type = DictConstant.DICT_SYS_CODE_TYPE_B_AP_REFUND_SOURCE_ADVANCE;
