...
import com.xinyirun.scm.core.system.mapper.sys.schedule.v2.SBDailyInventoryBatchV2Mappper;
import com.xinyirun.scm.core.system.mapper.sys.schedule.v2.SBDailyInventoryV2Mappper;
...
@Service
@Slf4j
public class SBDailyInventoryV2ServiceImpl extends BaseServiceImpl<SBDailyInventoryV2Mappper, BDailyInventoryEntity> implements ISBDailyInventoryV2Service {

    @Autowired
    SBDailyInventoryBatchV2Mappper mapper;
    ...
    @Autowired
    private ISBDailyProductV2Service productV2Service;
