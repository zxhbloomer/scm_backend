 ...
 * @Description: 自动生成编码：退款单
 */
@Component
public class BApReFundPayAutoCodeServiceImpl implements IAutoCodeService {
    ...
    public SCodeEntity autoCode() {
        String type = DictConstant.DICT_SYS_CODE_TYPE_B_AP_REFUND_PAY;
