...
/**
 * @ClassName: BSoSettlementAutoCodeServiceImpl
 * @Description: 自动生成编码：销售结算类
 * @Author: AI Assistant
 * @date: 2025/01/25
 * @Version: 1.0
 */
@Component
public class BSoSettlementAutoCodeServiceImpl implements IAutoCodeService {
    ...
    public SCodeEntity autoCode() {
        String type = DictConstant.DICT_SYS_CODE_TYPE_B_SO_SETTLEMENT;
