...
/**
 * @ClassName: BArReFundReceiveAutoCodeServiceImpl
 * @Description: 自动生成编码：应收退款收款单管理表
 */
@Component
public class BArReFundReceiveAutoCodeServiceImpl implements IAutoCodeService {
    ...
    public SCodeEntity autoCode() {
        String type = DictConstant.DICT_SYS_CODE_TYPE_B_AR_REFUND_RECEIVE;
