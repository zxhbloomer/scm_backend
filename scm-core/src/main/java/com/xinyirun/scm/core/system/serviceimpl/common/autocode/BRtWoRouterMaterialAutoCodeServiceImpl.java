 ...
 * @Description: 生产配方原材料管理 自动生成编码
 **/
@Component
public class BRtWoRouterMaterialAutoCodeServiceImpl implements IAutoCodeService {
    ...
    public SCodeEntity autoCode() {
        String type = DictConstant.DICT_B_RT_WO_ROUTER_MATERIAL;
