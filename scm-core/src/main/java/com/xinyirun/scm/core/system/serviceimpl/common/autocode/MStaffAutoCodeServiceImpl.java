...
/**
 * @ClassName: user auto code
 * @Description: 自动生成编码：员工编号
 * @Author: zxh
 * @date: 2019/12/13
 * @Version: 1.0
 */
@Component
public class MStaffAutoCodeServiceImpl implements IAutoCodeService {
    ...
    public SCodeEntity autoCode() {
        String type = DictConstant.DICT_SYS_CODE_TYPE_M_STAFF;
