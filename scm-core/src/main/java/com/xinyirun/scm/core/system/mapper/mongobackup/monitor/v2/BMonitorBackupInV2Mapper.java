...
import com.xinyirun.scm.bean.system.vo.mongo.monitor.v2.BMonitorInUnloadDataMongoV2Vo;
 ...
 */
@Repository
public interface BMonitorBackupInV2Mapper extends BaseMapper<BMonitorInEntity> {
    ...
    @Select("    "
            ...
            + "      ")
    BMonitorInUnloadDataMongoV2Vo selectMonitorInUnloadByMonitorId(@Param("p1") Integer id);
