...
/**
 * @ClassName: BArSourceAdvanceAutoCodeServiceImpl
 * @Description: 自动生成编码：应收预付款源单表
 */
@Component
public class BArSourceAdvanceAutoCodeServiceImpl implements IAutoCodeService {
    ...
    public SCodeEntity autoCode() {
        String type = DictConstant.DICT_SYS_CODE_TYPE_B_AR_SOURCE_ADVANCE;
