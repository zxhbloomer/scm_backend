 ...
 * @Version: 1.0
 */
@MappedTypes(value = {BMonitorFileVo.class})
@MappedJdbcTypes(value = {JdbcType.VARCHAR}, includeNullJdbcType = true)
public class BMonitorFileVoTypeHandler<T> extends BaseTypeHandler<T> {

    private Class<T> clazz;

    public BMonitorFileVoTypeHandler(Class<T> clazz) {
        if (clazz == null) {
