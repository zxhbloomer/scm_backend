 ...
 */
@Repository
public interface BMonitorBackupOutV2Mapper extends BaseMapper<BMonitorOutEntity> {
    ...
    @Select("    "
            ...
            + "      ")
    BMonitorOutDeliveryDataMongoV2Vo selectOutDeliveryByMonitorId(@Param("p1") Integer id);


    @Select("select 1 from b_monitor_out where id = #{p1.monitor_out_id}  for update")
