...
/**
 * @ClassName: BArReceiveAutoCodeServiceImpl
 * @Description: 自动生成编码：应收账款收款管理表
 */
@Component
public class BArReceiveAutoCodeServiceImpl implements IAutoCodeService {
    ...
    public SCodeEntity autoCode() {
        String type = DictConstant.DICT_SYS_CODE_TYPE_B_AR_RECEIVE;
