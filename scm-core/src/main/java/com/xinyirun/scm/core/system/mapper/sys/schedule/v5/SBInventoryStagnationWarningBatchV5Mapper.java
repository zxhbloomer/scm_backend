...
public interface SBInventoryStagnationWarningBatchV5Mapper extends BaseMapper<MInventoryEntity> {
    ...
    @Select(" SELECT                                                                                                     "
            ...
            +"  FROM b_in                                                                                                "
            +"  WHERE STATUS IN ("+ DictConstant.DICT_B_IN_STATUS_SUBMITTED+","+DictConstant.DICT_B_IN_STATUS_PASSED+")  "
    ...
    @Select(" SELECT                                                                                              "
            ...
            +" IN ("+ DictConstant.DICT_B_IN_STATUS_SUBMITTED+","+DictConstant.DICT_B_IN_STATUS_PASSED+")         "
