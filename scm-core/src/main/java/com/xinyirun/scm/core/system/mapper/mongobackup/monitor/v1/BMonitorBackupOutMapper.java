 ...
 */
@Repository
public interface BMonitorBackupOutMapper extends BaseMapper<BMonitorOutEntity> {
    ...
    @Select("    "
            ...
            + "      ")
    BMonitorOutDeliveryDataMongoVo selectOutDeliveryByMonitorId(@Param("p1") Integer id);
