package com.xinyirun.scm.core.system.serviceimpl.sys.schedule.v4;
...
import com.xinyirun.scm.core.system.mapper.sys.schedule.v4.SBDailyInventoryBatchV4Mapper;
...
@Service
@Slf4j
public class SBDailyInventoryV4ServiceImpl extends BaseServiceImpl<SBDailyInventoryBatchV4Mapper, BDailyInventoryEntity> implements ISBDailyInventoryV4Service {

    @Autowired
    private SBDailyInventoryBatchV4Mapper mapper;
