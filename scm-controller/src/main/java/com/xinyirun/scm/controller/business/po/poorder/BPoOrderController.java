...
import com.xinyirun.scm.bean.system.vo.business.po.poorder.PoOrderExportVo;
...
public class BPoOrderController {
    ...
    public ResponseEntity<JsonResultAo<IPage<PoOrderVo>>> selectOrderListForCargoRightTransferPage(@RequestBody(required = false) PoOrderVo searchCondition) {
        IPage<PoOrderVo> list = service.selectOrderListForCargoRightTransferPage(searchCondition);
        return ResponseEntity.ok().body(ResultUtil.OK(list));
    }
    ...
    @ResponseBody
    public ResponseEntity<JsonResultAo<PoOrderVo>> queryOrderListForCargoRightTransferPageSum(@RequestBody(required = false) PoOrderVo searchCondition) {
        PoOrderVo result = service.queryOrderListForCargoRightTransferPageSum(searchCondition);
        return ResponseEntity.ok().body(ResultUtil.OK(result));
    }
    ...
    public ResponseEntity<JsonResultAo<List<PoOrderDetailVo>>> selectDetailData(@RequestBody(required = false) PoOrderVo searchCondition) {
        List<PoOrderDetailVo> list = service.selectDetailData(searchCondition);
        return ResponseEntity.ok().body(ResultUtil.OK(list));
    }
