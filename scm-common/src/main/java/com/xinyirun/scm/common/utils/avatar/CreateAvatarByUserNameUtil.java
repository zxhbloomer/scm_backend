package com.xinyirun.scm.common.utils.avatar;
 ...
 * @Description: 头像生成工具类
 **/
public class CreateAvatarByUserNameUtil {
    /**
     * @throws IOException
     * @throws
     **/
    ...
    public static BufferedImage makeRoundedCorner(BufferedImage image, int cornerRadius) {
        ...
        // Clears the image so all pixels have zero alpha
        g2.setComposite(AlphaComposite.Clear);
        g2.fillRect(0, 0, w, h);

        // Apply color to the rounded rectangle
        g2.setComposite(AlphaComposite.Src);
        g2.setColor(Color.WHITE); // Change this color as needed or make it a parameter
        g2.fill(new RoundRectangle2D.Float(0, 0, w, h, cornerRadius, cornerRadius));

        // Draw the image on top of the rounded rectangle
