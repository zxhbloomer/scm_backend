...
public interface EntityRepository extends Neo4jRepository<EntityNode, Long> {
     ...
     */
    @Query("""
            MATCH (e:Entity {entity_uuid: $entity_uuid, tenant_id: $tenant_id})
            RETURN e
            """)
     ...
     */
    @Query("""
            MATCH (e:Entity {kb_uuid: $kb_uuid, tenant_id: $tenant_id})
            RETURN e
            """)
     ...
     */
    @Query("""
            MATCH (e1:Entity {entity_uuid: $entity1_uuid, tenant_id: $tenant_id}),
                  (e2:Entity {entity_uuid: $entity2_uuid, tenant_id: $tenant_id}),
