package com.xinyirun.scm.ai.service.elasticsearch;
...
import com.xinyirun.scm.ai.service.rag.AiKnowledgeBaseQaRefEmbeddingService;
...
public class VectorRetrievalService {
     ...
     */
    private static final String INDEX_NAME = "ai_knowledge_base_embedding";
    ...
    private float[] generateQuestionEmbedding(String question) {
        ...
        EmbeddingResponse response = embeddingModel.embedForResponse(Collections.singletonList(question));
