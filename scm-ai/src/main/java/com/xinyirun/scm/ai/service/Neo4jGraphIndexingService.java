...
import com.xinyirun.scm.ai.service.rag.AiKnowledgeBaseGraphSegmentService;
import com.xinyirun.scm.ai.service.splitter.OverlappingTokenTextSplitter;
...
public class Neo4jGraphIndexingService {
    ...
    public String ingestDocument(AiKnowledgeBaseEntity kb, AiKnowledgeBaseItemEntity item) {
        try {
            ...
            for (int i = 0; i < segments.size(); i++) {
                ...
                GraphExtractionResult graph = extractGraphFromSegment(segmentText, chatModel);
     ...
     * @return 提取结果（实体和关系）
     */
    private GraphExtractionResult extractGraphFromSegment(String segmentText, ChatModel chatModel) {
