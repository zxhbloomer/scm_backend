 ...
 */
@Mapper
public interface AiConversationContentRefGraphMapper extends BaseMapper<AiConversationContentRefGraphEntity> {
    ...
    @Delete("""
        <script>
        DELETE FROM ai_conversation_content_ref_graph
        WHERE message_id IN
