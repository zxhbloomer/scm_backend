...
public interface ExtAiTokenStatisticsMapper {
    ...
    @Select("SELECT " +
            "ats.model_source_id, " +
            "ams.name as model_name, " +
            "ams.provider_name as provider, " +
            "ams.model_type, " +
            ...
            "WHERE ats.statistics_date BETWEEN #{startDate} AND #{endDate} " +
            "GROUP BY ats.model_source_id, ams.name, ams.provider_name, ams.model_type " +
