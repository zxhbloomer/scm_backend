/**
 * Thread流程服务，提供基于Flowable的会话工作流历史查询和流程管理功能
 */
...
import com.xinyirun.scm.ai.thread.ThreadRestService;
import com.xinyirun.scm.ai.thread.dto.ThreadHistoryActivityResponse;
import com.xinyirun.scm.ai.thread.consts.ThreadConsts;
