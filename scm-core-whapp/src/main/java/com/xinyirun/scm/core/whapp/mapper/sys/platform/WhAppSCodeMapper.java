package com.xinyirun.scm.core.whapp.mapper.sys.platform;
 ...
 */
@Repository
public interface WhAppSCodeMapper extends BaseMapper<SCodeEntity> {
    ...
    @Select("    "
        ...
        + "  where true                                                              "
        + "      ")
    IPage<AppSCodeVo> selectPage(Page page, @Param("p1") AppSCodeVo searchCondition);
    ...
    @Select("    "
        ...
        + "  where true "
        + "      ")
    List<AppSCodeVo> select(@Param("p1") AppSCodeVo searchCondition);
    ...
    @Select("    "
        ...
        + "  where t1.id =  #{p1}"
        + "      ")
    AppSCodeVo selectId(@Param("p1") Long id);
