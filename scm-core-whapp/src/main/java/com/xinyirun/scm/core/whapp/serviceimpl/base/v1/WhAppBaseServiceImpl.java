package com.xinyirun.scm.core.whapp.serviceimpl.base.v1;
...
public class WhAppBaseServiceImpl<M extends BaseMapper<T>, T> extends ServiceImpl<M, T> implements WhAppIBaseService<T> {
