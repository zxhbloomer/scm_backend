 ...
 */
public class SystemExcelWriter extends SystemExcelBase {

    private OutputStream os;

    public SystemExcelWriter(File outFile) throws FileNotFoundException {
        this(new FileOutputStream(outFile));
    }

    public SystemExcelWriter(OutputStream os) {
        this.os = os;
    }
