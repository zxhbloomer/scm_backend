package com.xinyirun.scm.api.controller.steel.async.v2;
...
import com.xinyirun.scm.mq.rabbitmq.producer.business.monitor.v2.MonitorBackupV2Producer;
import com.xinyirun.scm.mq.rabbitmq.producer.business.monitor.v2.MonitorRenewV2Producer;
...
@Slf4j
@RestController
@RequestMapping(value = "/api/service/v2/async/monitor")
public class ApiBMonitorBackupV2Controller {
    ...
    @Autowired
    private MonitorBackupV2Producer backupProducer;

    @Autowired
    private IMonitorDataMongoV2Service monitorDataMongoService;

    @Autowired
    private MonitorRenewV2Producer renewProducer;
